...
The `pyproject.toml` shipped with [`project-template`](https://github.com/eweisbrod/project-template) looks like this (your own project's dependencies will differ — DuckDB is here because the templates use it, but plenty of research projects won't need it):
