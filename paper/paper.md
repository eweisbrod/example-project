...
- [**`example-project`**](https://eweisbrod.github.io/example-project/) — the teaching hub. Contains in-depth chapters on project structure, version control with Git and GitHub, integrated development environment (IDE) setup, Python virtual environments, environment variables and configuration files, AI-assistant integration via `AGENTS.md`, and a **SAS** [@SAS] macro reference for projects that retain SAS code.
