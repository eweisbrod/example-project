...
- **Stata** (≥ 17, for the `collect` framework used in the bundled `004-analyze-data.do`) with the `reghdfe`, `estout`, `projectpaths`, and `doenv` packages — only required if you picked a Stata-inclusive combo at setup.
